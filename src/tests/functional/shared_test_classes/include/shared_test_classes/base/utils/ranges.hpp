...
static std::map<ov::NodeTypeInfo, Range> inputRanges = {
    ...
    {ov::op::v5::GRUSequence::get_type_info_static(),
     Range({{0, 15}, {0, 15}, {0, 10, 1, 1, true}}, {{0, 8, 32}, {0, 8, 32}})},
    ...
    {ov::op::v9::ROIAlign::get_type_info_static(),
     Range({{0, 15}, {0, 1000, 1, 1, true}, {0, 1000, 1, 1, true}},
           {{-10, 20, 32768}, {0, 1000, 1, 1, true}, {0, 1000, 1, 1, true}})},
    ...
    {ov::op::v8::AdaptiveMaxPool::get_type_info_static(), Range({{0, 15}}, {{0, 8, 32}})},
    {ov::op::v8::AdaptiveAvgPool::get_type_info_static(), Range({{0, 15}}, {{0, 8, 32}})},
    {ov::op::v0::CTCGreedyDecoder::get_type_info_static(), Range({{0, 15}}, {{0, 8, 32}})},
    {ov::op::v6::GatherElements::get_type_info_static(), Range({{0, 15}}, {{0, 8, 32}})},
    {ov::op::v0::SpaceToDepth::get_type_info_static(), Range({{0, 15}}, {{0, 8, 32}})},
    {ov::op::v1::Split::get_type_info_static(), Range({{0, 15}}, {{0, 8, 32}})},
};
